...
from . import cte, lateral, guarded_lateral, apfel  # pyright: ignore[reportUnusedImport]  # noqa: F401
...
def generate(
    ...
    program: CFP.Program,
    dataflow: FlowSolution,
    symbol_table: SymbolTable,
) -> sql.SQL:
    return _GENERATORS[method.value](program, dataflow, symbol_table).generate()
