WITH RECURSIVE
  "🔄"("#️⃣", "left", "right", "🏷️", "📊.1") AS (
    ...
    (WITH
       ...
       "assignment.2"("#️⃣", "left", "right", "⚙️") AS (
       ...
       "assignment.3"("#️⃣", "left", "right", "⚙️") AS (
       ...
       "assignment.4"("#️⃣", "left", "next", "right", "⚙️") AS (
       ...
       "assignment.5"("#️⃣", "left", "next", "right", "⚙️", "🔍") AS (
       ...
       "where.4"("#️⃣", "left", "next", "right", "⚙️") AS (
       ...
       "emit.3"("#️⃣", "left", "next", "right", "⚙️", "📊.1") AS (
       ...
       "fork.3"("#️⃣", "flip", "left", "next", "right", "⚙️") AS (
       ...
       "assignment.6"("#️⃣", "left", "next", "right", "⚙️", "🔍") AS (
       ...
       "assignment.7"("#️⃣", "left", "right", "⚙️") AS (
       ...
       "assignment.8"("#️⃣", "left", "right", "⚙️") AS (
