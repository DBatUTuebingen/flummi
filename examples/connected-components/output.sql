WITH RECURSIVE
  "🔄"("🏷️", "#️⃣", "📊", "node", "component") AS (
    ...
    (WITH
       ...
       "start.2"("⚙️", "#️⃣", "node", "component") AS (
         SELECT NULL AS "⚙️",
                "🔄"."#️⃣" AS "#️⃣",
                "🔄"."node" AS "node",
       ...
       "assignment.1"("⚙️", "#️⃣", "node", "component") AS (
       ...
       "merge.1"("⚙️", "#️⃣", "node", "component") AS (
       ...
       "assignment.2"("node", "component", "⚙️", "#️⃣", "old_components") AS (
       ...
       "fork.2"("node", "component", "⚙️", "#️⃣", "old_components") AS (
         ...
         FROM   "assignment.2",
                LATERAL (SELECT there
                         FROM   edges
                         WHERE  here = ("assignment.2"."node")) AS "ℚ"("node")
       ),
       "gather.1"("node", "component", "⚙️", "#️⃣", "old_components") AS (
       ...
       "assignment.3"("⚙️", "node", "component", "new_components", "#️⃣", "old_components") AS (
       ...
       "assignment.4"("node", "component", "cond", "⚙️", "#️⃣") AS (
       ...
       "where.2"("⚙️", "#️⃣", "node", "component") AS (
