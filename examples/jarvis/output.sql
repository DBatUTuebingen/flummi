WITH RECURSIVE
  "🔄"("🏷️", "#️⃣", "📊.1", "p", "p0") AS (
    ...
    (WITH
       ...
       "assignment.1"("p0", "⚙️", "#️⃣") AS (
         SELECT CAST((SELECT arg_min(p, p.x) FROM points AS p) AS point) AS "p0",
                "start.1"."⚙️" AS "⚙️",
                "start.1"."#️⃣" AS "#️⃣"
         FROM   "start.1"
       ),
       "assignment.2"("p", "p0", "⚙️", "#️⃣") AS (
       ...
       "assignment.4"("🔍", "⚙️", "p", "p0", "#️⃣") AS (
         SELECT CAST((("assignment.3"."p") = ("assignment.3"."p0")) AS boolean) AS "🔍",
                "assignment.3"."⚙️" AS "⚙️",
                "assignment.3"."p" AS "p",
