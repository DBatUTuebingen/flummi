WITH RECURSIVE
  "🔄"("🏷️", "#️⃣", "📊", "centroids", "centroid") AS (
    ...
    (WITH
       ...
       "start.2"("#️⃣", "centroids", "⚙️", "centroid") AS (
         SELECT "🔄"."#️⃣" AS "#️⃣",
       ...
       "merge.1"("#️⃣", "centroids", "⚙️", "centroid") AS (
       ...
       "fork.2"("centroids", "centroid", "#️⃣", "⚙️", "point") AS (
       ...
       "assignment.2"("#️⃣", "centroid", "point", "centroids", "distance", "⚙️") AS (
       ...
       "gather.1"("centroids", "centroid", "#️⃣", "⚙️", "point") AS (
       ...
       "gather.2"("new_centroid", "centroids", "centroid", "#️⃣", "⚙️") AS (
       ...
       "assignment.3"("new_centroid", "centroids", "centroid", "#️⃣", "old_centroids", "⚙️") AS (
       ...
       "assignment.4"("🔍", "new_centroid", "centroid", "centroids", "#️⃣", "⚙️") AS (
       ...
       "where.1"("#️⃣", "new_centroid", "⚙️", "centroids") AS (
       ...
       "assignment.5"("#️⃣", "centroids", "⚙️", "centroid") AS (
         SELECT "where.1"."#️⃣" AS "#️⃣",
                "where.1"."centroids" AS "centroids",
                "where.1"."⚙️" AS "⚙️",
       ...
       "assignment.6"("centroid", "point", "#️⃣", "distance", "⚙️") AS (
       ...
       "jump.1"("🏷️", "centroids", "centroid", "#️⃣") AS (
         SELECT 'start.2' AS "🏷️",
