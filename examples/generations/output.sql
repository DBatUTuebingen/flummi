WITH RECURSIVE
  "🔄"("#️⃣", "age", "birth_cond", "height", "iterations", "max_age", "survive_cond", "width", "x", "y", "🏷️", "📊.1") AS (
    ...
    (WITH
       ...
       "assignment.1"("#️⃣", "height", "iterations", "max_age", "width", "⚙️") AS (
       ...
       "assignment.2"("#️⃣", "birth_cond", "height", "iterations", "max_age", "survive_cond", "width", "⚙️") AS (
       ...
       "fork.1"("#️⃣", "birth_cond", "height", "iterations", "max_age", "survive_cond", "width", "x", "⚙️") AS (
       ...
       "fork.2"("#️⃣", "birth_cond", "height", "iterations", "max_age", "survive_cond", "width", "x", "y", "⚙️") AS (
       ...
       "assignment.3"("#️⃣", "age", "birth_cond", "height", "iterations", "max_age", "survive_cond", "width", "x", "y", "⚙️") AS (
       ...
       "start.2"("#️⃣", "age", "birth_cond", "height", "iterations", "max_age", "survive_cond", "width", "x", "y", "⚙️") AS (
         SELECT "🔄"."#️⃣" AS "#️⃣",
                "🔄"."age" AS "age",
       ...
       "merge.1"("#️⃣", "age", "birth_cond", "height", "iterations", "max_age", "survive_cond", "width", "x", "y", "⚙️") AS (
       ...
       "fork.3"("#️⃣", "age", "birth_cond", "flip", "height", "iterations", "max_age", "survive_cond", "width", "x", "y", "⚙️") AS (
       ...
       "assignment.4"("#️⃣", "age", "birth_cond", "height", "iterations", "max_age", "survive_cond", "width", "x", "y", "⚙️", "🔍") AS (
       ...
       "where.1"("#️⃣", "age", "iterations", "width", "x", "y", "⚙️") AS (
       ...
       "gather.2"("#️⃣", "buffer", "iterations", "width", "y", "⚙️") AS (
       ...
       "gather.3"("#️⃣", "buffer", "iterations", "width", "⚙️") AS (
       ...
       "emit.1"("#️⃣", "iterations", "width", "⚙️", "📊.1") AS (
       ...
       "assignment.16"("#️⃣", "buffer", "width", "⚙️") AS (
       ...
       "where.2"("#️⃣", "age", "birth_cond", "height", "iterations", "max_age", "survive_cond", "width", "x", "y", "⚙️") AS (
         SELECT "assignment.4"."#️⃣" AS "#️⃣",
                "assignment.4"."age" AS "age",
       ...
       "assignment.5"("#️⃣", "age", "birth_cond", "height", "iterations", "max_age", "survive_cond", "width", "x", "y", "⚙️", "🔍") AS (
       ...
       "where.4"("#️⃣", "age", "birth_cond", "height", "iterations", "max_age", "survive_cond", "width", "x", "y", "⚙️") AS (
       ...
       "assignment.6"("#️⃣", "age", "birth_cond", "height", "iterations", "max_age", "survive_cond", "width", "x", "y", "⚙️") AS (
       ...
       "fork.4"("#️⃣", "age", "birth_cond", "dy", "height", "iterations", "max_age", "survive_cond", "width", "x", "y", "⚙️") AS (
       ...
       "fork.5"("#️⃣", "age", "birth_cond", "dx", "dy", "height", "iterations", "max_age", "survive_cond", "width", "x", "y", "⚙️") AS (
       ...
       "assignment.7"("#️⃣", "age", "birth_cond", "dx", "dy", "height", "iterations", "max_age", "survive_cond", "width", "x", "y", "⚙️") AS (
       ...
       "assignment.8"("#️⃣", "age", "birth_cond", "height", "iterations", "max_age", "original", "survive_cond", "width", "x", "y", "⚙️") AS (
       ...
       "gather.1"("#️⃣", "age", "birth_cond", "height", "iterations", "max_age", "neighbors", "survive_cond", "width", "x", "y", "⚙️") AS (
       ...
       "assignment.9"("#️⃣", "age", "birth_cond", "height", "iterations", "max_age", "neighbors", "survive_cond", "width", "x", "y", "⚙️", "🔍") AS (
       ...
       "where.5"("#️⃣", "birth_cond", "height", "iterations", "max_age", "survive_cond", "width", "x", "y", "⚙️") AS (
       ...
       "assignment.10"("#️⃣", "age", "birth_cond", "height", "iterations", "max_age", "survive_cond", "width", "x", "y", "⚙️") AS (
       ...
       "where.6"("#️⃣", "age", "birth_cond", "height", "iterations", "max_age", "neighbors", "survive_cond", "width", "x", "y", "⚙️") AS (
         SELECT "assignment.9"."#️⃣" AS "#️⃣",
       ...
       "assignment.11"("#️⃣", "age", "birth_cond", "height", "iterations", "max_age", "survive_cond", "width", "x", "y", "⚙️", "🔍") AS (
       ...
       "where.7"("#️⃣", "birth_cond", "height", "iterations", "max_age", "survive_cond", "width", "x", "y", "⚙️") AS (
       ...
       "assignment.12"("#️⃣", "age", "birth_cond", "height", "iterations", "max_age", "survive_cond", "width", "x", "y", "⚙️") AS (
       ...
       "where.8"("#️⃣", "age", "birth_cond", "height", "iterations", "max_age", "survive_cond", "width", "x", "y", "⚙️") AS (
         SELECT "assignment.11"."#️⃣" AS "#️⃣",
       ...
       "assignment.13"("#️⃣", "age", "birth_cond", "height", "iterations", "max_age", "survive_cond", "width", "x", "y", "⚙️", "🔍") AS (
       ...
       "where.10"("#️⃣", "age", "birth_cond", "height", "iterations", "max_age", "survive_cond", "width", "x", "y", "⚙️") AS (
       ...
       "where.9"("#️⃣", "age", "birth_cond", "height", "iterations", "max_age", "survive_cond", "width", "x", "y", "⚙️") AS (
         SELECT "assignment.13"."#️⃣" AS "#️⃣",
                "assignment.13"."age" AS "age",
                "assignment.13"."birth_cond" AS "birth_cond",
                "assignment.13"."height" AS "height",
       ...
       "assignment.14"("#️⃣", "age", "birth_cond", "height", "iterations", "max_age", "survive_cond", "width", "x", "y", "⚙️") AS (
       ...
       "merge.2"("#️⃣", "age", "birth_cond", "height", "iterations", "max_age", "survive_cond", "width", "x", "y", "⚙️") AS (
       ...
       "assignment.15"("#️⃣", "age", "birth_cond", "height", "iterations", "max_age", "survive_cond", "width", "x", "y", "⚙️") AS (
       ...
       "jump.1"("#️⃣", "age", "birth_cond", "height", "iterations", "max_age", "survive_cond", "width", "x", "y", "🏷️") AS (
