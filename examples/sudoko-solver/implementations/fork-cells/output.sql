WITH RECURSIVE
  "🔄"("#️⃣", "cells", "empty_cells", "🏷️", "📊.1") AS (
    ...
    (WITH
       ...
       "fork.1"("#️⃣", "cells", "empty_cells", "idx", "⚙️") AS (
       ...
       "assignment.3"("#️⃣", "cell", "cells", "empty_cells", "idx", "⚙️") AS (
       ...
       "fork.2"("#️⃣", "cell", "cells", "empty_cells", "value", "⚙️") AS (
       ...
       "assignment.5"("#️⃣", "cell", "cells", "empty_cells", "ok", "value", "⚙️") AS (
       ...
       "assignment.6"("#️⃣", "cell", "cells", "empty_cells", "value", "⚙️", "🔍") AS (
       ...
       "assignment.7"("#️⃣", "cells", "empty_cells", "⚙️") AS (
       ...
       "assignment.8"("#️⃣", "cells", "empty_cells", "⚙️", "🔍") AS (
