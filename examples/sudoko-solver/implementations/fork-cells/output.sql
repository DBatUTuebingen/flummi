WITH RECURSIVE
  "🔄"("🏷️", "#️⃣", "📊.1", "empty_cells", "cells") AS (
    ...
    (WITH
       ...
       "fork.1"("⚙️", "idx", "#️⃣", "empty_cells", "cells") AS (
       ...
       "assignment.3"("⚙️", "idx", "cell", "#️⃣", "empty_cells", "cells") AS (
       ...
       "assignment.4"("⚙️", "#️⃣", "cell", "empty_cells", "cells") AS (
       ...
       "fork.2"("⚙️", "#️⃣", "cell", "value", "empty_cells", "cells") AS (
       ...
       "assignment.5"("⚙️", "ok", "#️⃣", "cell", "value", "empty_cells", "cells") AS (
       ...
       "where.1"("⚙️", "#️⃣", "cell", "value", "empty_cells", "cells") AS (
       ...
       "assignment.6"("⚙️", "empty_cells", "#️⃣", "cells") AS (
       ...
       "assignment.7"("done", "⚙️", "#️⃣", "empty_cells", "cells") AS (
         SELECT CAST((length(("assignment.6"."empty_cells")) = 0) AS boolean) AS "done",
                "assignment.6"."⚙️" AS "⚙️",
       ...
       "where.4"("#️⃣", "empty_cells", "cells") AS (
