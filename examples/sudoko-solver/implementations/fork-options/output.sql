WITH RECURSIVE
  "🔄"("🏷️", "#️⃣", "📊", "cells", "id") AS (
    ...
    (WITH
       ...
       "assignment.2"("cells", "id", "cell", "#️⃣", "⚙️") AS (
       ...
       "assignment.3"("cells", "done", "id", "cell", "#️⃣", "⚙️") AS (
       ...
       "assignment.4"("cells", "id", "cell", "#️⃣", "ok", "value", "⚙️") AS (
       ...
       "where.3"("cells", "id", "cell", "#️⃣", "value") AS (
