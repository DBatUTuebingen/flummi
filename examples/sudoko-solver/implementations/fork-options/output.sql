WITH RECURSIVE
  "🔄"("🏷️", "#️⃣", "📊.1", "cells", "id") AS (
    ...
    (WITH
       ...
       "fork.1"("cells", "#️⃣", "⚙️") AS (
         SELECT "ℚ"."cells" AS "cells",
                "start.1"."#️⃣" AS "#️⃣",
                "start.1"."⚙️" AS "⚙️"
         FROM   "start.1",
                (SELECT cells
       ...
       "assignment.2"("cells", "cell", "⚙️", "#️⃣", "id") AS (
       ...
       "assignment.3"("cells", "cell", "⚙️", "#️⃣", "done", "id") AS (
       ...
       "assignment.4"("cells", "cell", "#️⃣", "value", "ok", "⚙️", "id") AS (
       ...
       "where.3"("cells", "cell", "value", "#️⃣", "id") AS (
