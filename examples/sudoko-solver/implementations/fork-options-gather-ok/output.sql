WITH RECURSIVE
  "🔄"("🏷️", "#️⃣", "📊", "cells", "empty_cells") AS (
    ...
    (WITH
       ...
       "assignment.2"("#️⃣", "cells", "⚙️", "empty_cells") AS (
       ...
       "merge.1"("#️⃣", "cells", "⚙️", "empty_cells") AS (
       ...
       "assignment.3"("cell", "#️⃣", "cells", "⚙️", "empty_cells") AS (
       ...
       "assignment.4"("cell", "#️⃣", "cells", "⚙️", "empty_cells") AS (
       ...
       "fork.1"("cell", "#️⃣", "value", "cells", "⚙️", "empty_cells") AS (
       ...
       "fork.2"("cell", "offset", "#️⃣", "cells", "value", "⚙️", "empty_cells") AS (
         SELECT "fork.1"."cell" AS "cell",
                "ℚ"."offset" AS "offset",
                "fork.1"."#️⃣" AS "#️⃣",
       ...
       "assignment.5"("value", "cell", "offset", "#️⃣", "row_ok", "cells", "⚙️", "empty_cells") AS (
       ...
       "assignment.6"("col_ok", "#️⃣", "cells", "⚙️", "empty_cells", "cell", "offset", "row_ok", "value") AS (
       ...
       "assignment.7"("col_ok", "#️⃣", "value", "⚙️", "empty_cells", "cell", "row_ok", "box_ok", "cells") AS (
       ...
       "gather.1"("cell", "ok", "#️⃣", "cells", "value", "⚙️", "empty_cells") AS (
         SELECT "assignment.7"."cell" AS "cell",
       ...
       "where.1"("cell", "#️⃣", "cells", "value", "⚙️", "empty_cells") AS (
         SELECT "gather.1"."cell" AS "cell",
                "gather.1"."#️⃣" AS "#️⃣",
       ...
       "assignment.8"("#️⃣", "cells", "⚙️", "empty_cells") AS (
       ...
       "assignment.9"("done", "#️⃣", "cells", "⚙️", "empty_cells") AS (
         SELECT CAST((length(("assignment.8"."empty_cells")) = 0) AS boolean) AS "done",
       ...
       "jump.1"("empty_cells", "🏷️", "cells", "#️⃣") AS (
         SELECT "where.4"."empty_cells" AS "empty_cells",
                'start.2' AS "🏷️",
