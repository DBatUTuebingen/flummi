WITH RECURSIVE
  "🔄"("#️⃣", "cells", "empty_cells", "🏷️", "📊.1") AS (
    ...
    (WITH
       ...
       "assignment.2"("#️⃣", "cells", "empty_cells", "⚙️") AS (
       ...
       "start.2"("#️⃣", "cells", "empty_cells", "⚙️") AS (
         SELECT "🔄"."#️⃣" AS "#️⃣",
                "🔄"."cells" AS "cells",
       ...
       "merge.1"("#️⃣", "cells", "empty_cells", "⚙️") AS (
       ...
       "assignment.3"("#️⃣", "cell", "cells", "empty_cells", "⚙️") AS (
       ...
       "assignment.4"("#️⃣", "cell", "cells", "empty_cells", "⚙️") AS (
       ...
       "fork.1"("#️⃣", "cell", "cells", "empty_cells", "value", "⚙️") AS (
       ...
       "fork.2"("#️⃣", "cell", "cells", "empty_cells", "offset", "value", "⚙️") AS (
       ...
       "assignment.5"("#️⃣", "cell", "cells", "empty_cells", "offset", "row_ok", "value", "⚙️") AS (
       ...
       "assignment.6"("#️⃣", "cell", "cells", "col_ok", "empty_cells", "offset", "row_ok", "value", "⚙️") AS (
       ...
       "assignment.7"("#️⃣", "box_ok", "cell", "cells", "col_ok", "empty_cells", "row_ok", "value", "⚙️") AS (
       ...
       "gather.1"("#️⃣", "cell", "cells", "empty_cells", "ok", "value", "⚙️") AS (
       ...
       "assignment.8"("#️⃣", "cell", "cells", "empty_cells", "value", "⚙️", "🔍") AS (
       ...
       "where.1"("#️⃣", "cell", "cells", "empty_cells", "value", "⚙️") AS (
       ...
       "assignment.9"("#️⃣", "cells", "empty_cells", "⚙️") AS (
       ...
       "where.4"("#️⃣", "cells", "empty_cells", "⚙️") AS (
         SELECT "assignment.10"."#️⃣" AS "#️⃣",
                "assignment.10"."cells" AS "cells",
       ...
       "jump.1"("#️⃣", "cells", "empty_cells", "🏷️") AS (
