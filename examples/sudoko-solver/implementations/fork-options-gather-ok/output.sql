WITH RECURSIVE
  "🔄"("🏷️", "#️⃣", "📊.1", "cells", "empty_cells") AS (
    ...
    (WITH
       ...
       "start.2"("cells", "#️⃣", "⚙️", "empty_cells") AS (
       ...
       "assignment.2"("⚙️", "#️⃣", "cells", "empty_cells") AS (
       ...
       "merge.1"("⚙️", "#️⃣", "cells", "empty_cells") AS (
       ...
       "assignment.3"("#️⃣", "cell", "⚙️", "cells", "empty_cells") AS (
       ...
       "assignment.4"("#️⃣", "cell", "⚙️", "cells", "empty_cells") AS (
       ...
       "fork.1"("value", "#️⃣", "cell", "⚙️", "cells", "empty_cells") AS (
       ...
       "fork.2"("value", "#️⃣", "cell", "offset", "⚙️", "cells", "empty_cells") AS (
       ...
       "assignment.5"("row_ok", "value", "#️⃣", "cell", "offset", "⚙️", "cells", "empty_cells") AS (
         SELECT CAST((("fork.2"."value") <> ("fork.2"."cells")[(("fork.2"."cell") // 9) * 9                      + ("fork.2"."offset")                   ]) AS boolean) AS "row_ok",
       ...
       "assignment.6"("row_ok", "col_ok", "#️⃣", "cell", "offset", "⚙️", "empty_cells", "value", "cells") AS (
       ...
       "assignment.7"("row_ok", "col_ok", "box_ok", "#️⃣", "cell", "⚙️", "empty_cells", "value", "cells") AS (
       ...
       "gather.1"("ok", "value", "cell", "cells", "#️⃣", "⚙️", "empty_cells") AS (
         SELECT bool_and(("assignment.7"."row_ok") AND ("assignment.7"."col_ok") AND ("assignment.7"."box_ok")) AS "ok",
       ...
       "where.1"("value", "#️⃣", "cell", "⚙️", "cells", "empty_cells") AS (
       ...
       "assignment.8"("⚙️", "#️⃣", "cells", "empty_cells") AS (
       ...
       "assignment.9"("#️⃣", "done", "cells", "⚙️", "empty_cells") AS (
